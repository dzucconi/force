...
fragment ArtworkImageSwiper_artwork on Artwork {
  ...
  frames: images {
    internalID
    _1x: resized(width: 400, height: 400, version: ["normalized", "large"]) {
      url
      width
      height
    }
    _2x: resized(width: 800, height: 800, version: ["normalized", "large"]) {
      url
    }
  }
}
...
fragment ArtworkImages_artwork on Artwork {
  ...
  images {
    internalID
    _1x: resized(width: 700, height: 700, version: ["normalized", "large"]) {
      url
      width
      height
    }
    _2x: resized(width: 1400, height: 1400, version: ["normalized", "large"]) {
      url
    }
  }
}
